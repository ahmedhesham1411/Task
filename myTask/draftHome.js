  ...
  render() {
    ...
    return (
      <ImageBackground source={require('../app/images/darkFlowers.png')}
                        style={{resizeMode:'cover',height:80,width:430}}>

          <View style={{ flexDirection: 'row',justifyContent:'space-between',backgroundColor: 'rgba(0,0,0, .7)',borderBottomWidth:5,height:80,width:'100%'}}>
              ...
              <Image
                ...
                style={{ width: 25, height: 25,marginRight:30,marginTop:30}}
              />
              </View>
    ...
    return (
      ...
      <View style={styles.sideMenuContainer}>
          ...
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
                ...
                <Text style={styles.menuText} onPress={() => { this.props.navigation.navigate('Second') }} > شارك التطبيق  </Text>
